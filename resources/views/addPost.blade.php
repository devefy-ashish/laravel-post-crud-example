    ...
    <form action="{{ route('submitPost') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="content" id="content" required rows="4"
                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500 focus:border-blue-500" placeholder="Enter post description"></textarea>
        </div>
